    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          // Codex Fleet Surfaces
          route(
            ":workspaceSlug/projects/:projectId/fleet-logs",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/fleet-logs/page.tsx"
          ),
          route(
            ":workspaceSlug/projects/:projectId/agents",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/agents/page.tsx"
          ),
          route(
            ":workspaceSlug/projects/:projectId/runs",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/runs/page.tsx"
          ),
          route(
            ":workspaceSlug/projects/:projectId/artifacts",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/artifacts/page.tsx"
          ),
          route(
            ":workspaceSlug/projects/:projectId/codex-settings",
            "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/codex-settings/page.tsx"
          ),
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            route(
              ...
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/codex-fleet/page.tsx"
            ),
            // Project Automations
