  ...
  return (
    <div className="mt-3 flex flex-col divide-y divide-subtle px-3">
      <div className="shrink-0 pb-3">
        <div className="p-2 text-caption-md-medium text-tertiary capitalize">agent control</div>
        <SettingsSidebarItem
          as="link"
          href={`/${workspaceSlug}/settings/projects/${projectId}/codex-fleet/`}
          isActive={new RegExp(`^/${workspaceSlug}/settings/projects/${projectId}/codex-fleet/`).test(pathname)}
          icon={PROJECT_SETTINGS_ICONS.codex_fleet}
          label="Codex Fleet"
        />
        <SettingsSidebarItem
          as="link"
          href="/codex-fleet/dashboard"
          isActive={pathname === "/codex-fleet/dashboard"}
          icon={PROJECT_SETTINGS_ICONS.codex_fleet}
          label="Fleet Logs"
        />
      </div>
